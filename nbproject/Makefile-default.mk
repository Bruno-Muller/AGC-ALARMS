...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/AGC_ALARMS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=main.c i2c.c io.c timer.c interrupt.c alarms.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/io.p1 ${OBJECTDIR}/timer.p1 ${OBJECTDIR}/interrupt.p1 ${OBJECTDIR}/alarms.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/i2c.p1.d ${OBJECTDIR}/io.p1.d ${OBJECTDIR}/timer.p1.d ${OBJECTDIR}/interrupt.p1.d ${OBJECTDIR}/alarms.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/io.p1 ${OBJECTDIR}/timer.p1 ${OBJECTDIR}/interrupt.p1 ${OBJECTDIR}/alarms.p1

# Source Files
SOURCEFILES=main.c i2c.c io.c timer.c interrupt.c alarms.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/AGC_ALARMS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/alarms.p1: alarms.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/alarms.p1.d 
	@${RM} ${OBJECTDIR}/alarms.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/alarms.p1  alarms.c 
	@-${MV} ${OBJECTDIR}/alarms.d ${OBJECTDIR}/alarms.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/alarms.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
